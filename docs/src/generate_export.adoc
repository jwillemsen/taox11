...
= Generating an additional export file

At the moment shared libraries are used export macros have to be used to export
...
Todo: show how to add custom arguments

When your ruby method has a problem it can use `IDL.error` to report an error message to
